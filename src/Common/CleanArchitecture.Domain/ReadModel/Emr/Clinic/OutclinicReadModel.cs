...
{
    public class OutclinicReadModel
    {
        public OutclinicReadModel()
        {
            LstServicesOrder = new List<EmrServicesOrderReadModel>();
            LstDrugsOrder = new List<EmrDrugsOrderReadModel>();
        }
